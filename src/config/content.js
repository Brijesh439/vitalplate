...
export const historyFormConfig = {
  ...
  medicalHistory: [
    ...
    {
      label: "Past surgeries or treatments",
      type: "textarea",
      name: "surgeries",
    },
    {
      label: "Allergies or food intolerances",
      type: "textarea",
      name: "allergies",
    },
    { label: "Current Meal Time in day", type: "text", name: "mealTime" },
    {
      label: "Preference for specific cuisines or ingredients",
      type: "text",
      name: "cuisinePreferences",
    },
    {
      label: "Consumption of snacks, sweets, and beverages",
      type: "text",
      name: "consumption",
    },
  ],
  lifestyleFactors: [
    ...
    {
      label: "Smoking or alcohol consumption",
      type: "text",
      name: "smokingAlcohol",
    },
  ],
  goalsPreferences: [
    ...
    {
      label: "Short-term and long-term dietary goals",
      type: "text",
      name: "dietaryGoals",
    },
  ],
  psychosocialFactors: [
    {
      label: "Emotional relationship with food",
      type: "textarea",
      name: "emotionalRelationship",
    },
    {
      label: "Social and cultural influences on food choices",
      type: "textarea",
      name: "socialCulturalInfluences",
    },
  ],
};
